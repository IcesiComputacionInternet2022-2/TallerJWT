    ...
    protected void doFilterInternal(
        ...
        try {
            if (containsToken(request)) {
                ...
                createUnauthorizedFilter(new UserDemoException(HttpStatus.UNAUTHORIZED, new UserDemoError(UserDemoErrorCode.CODE_AUTH_01, UserDemoErrorCode.CODE_AUTH_01.getMessage())), response);
            }
